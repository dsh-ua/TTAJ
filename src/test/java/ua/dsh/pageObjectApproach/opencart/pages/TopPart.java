...
public abstract class TopPart {
    ...
    protected ShoppingCartEmptyPage getShoppingCartEmptyPage() {
        if (shoppingCartEmptyPage == null) {
            // TODO Develop Custom Exception
            throw new RuntimeException(OPTION_NULL_MESSAGE);
        }
        return shoppingCartEmptyPage;
    }

    private ShoppingCartEmptyPage createShoppingCartEmptyPage(){
        shoppingCartEmptyPage = new ShoppingCartEmptyPage(driver);
        return getShoppingCartEmptyPage();
    }
    ...
    public ShoppingCartEmptyPage goToShoppingCartPage (){
        clickShoppingCart();
        createShoppingCartEmptyPage();
        return getShoppingCartEmptyPage();
    }
